...
The block runs inline, in the process that fires it. That is the same footing
as any hook written as a class, and the same responsibility: a block that
blocks, blocks maintenance.
"""
