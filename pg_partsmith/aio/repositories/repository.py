...
class PostgresPartitionRepository:
    ...
    async def attach_partition(
        ...
        *,
        ...
        """
        await self._creator.attach(parent_name, partition_name, bounds, key_arity=key_arity, expected_oid=expected_oid)
    ...
    async def drop_partition(
        ...
        """
        return await self._remover.drop(partition_name, expected_oid=expected_oid, drain_into=drain_into)
