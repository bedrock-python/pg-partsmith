...
class PartitionValidationService:
    ...
    async def validate_config(self, config: TablePartitionConfig) -> None:
        ...
        await self._validate_unique_constraints(config, qualified_parent)

    async def _validate_unique_constraints(self, config: TablePartitionConfig, qualified_parent: str) -> None:
