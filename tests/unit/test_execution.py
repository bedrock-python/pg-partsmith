...
async def test__apply__detach_op__revalidates_then_detaches_with_hooks_around_it(
    ...
    # Assert
    repo.detach_partition.assert_awaited_once_with("events", "events__2024_03", mode=DetachMode.BLOCKING)
...
async def test__apply__drop_op__drops_with_the_expected_oid_and_hooks_around_it(
    ...
    # Assert
    repo.drop_partition.assert_awaited_once_with("events__2023_12", expected_oid=55)
    assert hooks.calls == [
...
async def test__apply__drop_following_a_successful_detach__is_dropped(
    ...
    # Assert
    repo.drop_partition.assert_awaited_once_with("events__2024_03", expected_oid=77)
    assert result.detached_count == 1
    assert result.dropped_count == 1
